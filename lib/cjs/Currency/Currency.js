...
const Currency = React.forwardRef((props, ref) => {
    const { className, symbol, symbolClassName, value, fixed = 2, side, delimiter } = props, other = __rest(props, ["className", "symbol", "symbolClassName", "value", "fixed", "side", "delimiter"]);
