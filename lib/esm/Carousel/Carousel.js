...
const Carousel = props => {
    ...
    return (React.createElement("div", { className: cn() },
        props.images.length > 1 && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: cn('pause-play') }, isAuto ? (React.createElement(Icon, { onClick: () => setAuto(false), icon: "pause_circle_outline" })) : (React.createElement(Icon, { onClick: () => setAuto(true), icon: "play_circle_outline" }))),
            ...
            React.createElement("div", { className: cn('control') }, Array(props.images.length)
                .fill(0)
                .map((_, i) => (React.createElement("div", { onClick: gotoActive(i), key: i, className: cn('control__data') },
                React.createElement("div", { className: getClass(i), style: { animationDuration: i === active ? `${props.autoPlayDuration}s` : '' } }))))))),
