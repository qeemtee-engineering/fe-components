...
import reactLifecyclesCompat, { polyfill as polyfill$1 } from 'react-lifecycles-compat';
...
var disableScroll = function (preventDefault, overflow) {
...
var enableScroll = function (preventDefault, overflow) {
    if (overflow === void 0) { overflow = false; }
    if (overflow) {
...
var extractFromUrl = function (Languages, defaultLang) {
    try {
        var language_1 = window.location.href.split('/').find(function (p) { return p.length === 2; });
        var match = Languages.find(function (l) { return l === language_1; });
        if (match) {
            return match;
        }
        language_1 = returnDefault(Languages, defaultLang);
        return language_1;
    }
    catch (err) {
...
var returnDefault = function (Languages, defaultLang) {
    return Languages.find(function (l) { return l === defaultLang; }) || Languages[0];
};
var changeUrlLanguage = function (code) {
    return window.location.origin + "/" + code + "/" + window.location.pathname
        .replace(/\/[a-z]{2}\//g, '')
        .replace(/^\/|\/$/g, '');
};
var createPath = function (languages, path) {
    return "/:lng(" + languages.join('|') + ")?" + path;
};

var checkPhoneNumberValidity = isValidPhoneNumber;
var getPassedPhoneNumber = parsePhoneNumber;
...
var cn = withNaming({ e: '__', m: '-' })('Button');
...
var cn$1 = withNaming({ e: '__', m: '-' })('Modal');
var mousePosition;
...
var cn$2 = withNaming({ e: '__', m: '-' })('Table');
...
var cn$3 = withNaming({ e: '__', m: '--' })('Input');
var Input = React__default.forwardRef(function (props, ref) {
    var _a = useState('text'), type = _a[0], setType = _a[1];
    ...
    useEffect(function () { return setType(otherProps.type || 'text'); }, []);
...
var TranslateProvider = function (_a) {
    var children = _a.children, languageStore = _a.languageStore;
    return (React__default.createElement(LanguageContext.Provider, { value: {
            translations: languageStore.resource,
            defaultLang: languageStore.defaultLang,
        } }, children));
};

var TranslateConnect = function (Component) {
    return function (props) {
        var selectLanguage = function (value) {
            try {
                var currentLanguage = extractFromUrl(Object.keys(value.translations), value.defaultLang);
        ...
        return (React__default.createElement(LanguageContext.Consumer, null, function (value) { return React__default.createElement(Component, __assign({ translation: selectLanguage(value) }, props)); }));
    };
};
...
var cn$4 = withNaming({ e: '__', m: '--' })('LanguageSwitch');
var LanguageSwitch = function () {
    var value = useContext(LanguageContext);
    var language = extractFromUrl(Object.keys(value.translations), value.defaultLang);
    ...
    var getClassName = function (ln) {
        if (ln === language) {
            return cn$4('active');
        }
        return '';
    };
    return (React__default.createElement("div", { className: cn$4() }, Object.keys(value.translations).map(function (l, index) {
        return (React__default.createElement(Fragment, { key: index },
            index !== 0 && React__default.createElement("span", null, "/"),
            React__default.createElement("span", { className: getClassName(l), onClick: function () {
                    handleClose(l);
                } }, mapping[l])));
    })));
};
...
var PhoneNumber = (function (_super) {
    ...
    PhoneNumber.prototype.render = function () {
        ...
        return (React__default.createElement(PhoneInput, __assign({}, otherProps, { value: this.state.valueToPass, onChange: function (phone) { return _this.emitChange(phone); }, inputClassName: !this.props.hasContact
...
var cn$5 = withNaming({ e: '__', m: '-' })('OverlayComponent');
var OverlayComponent = function (_a) {
    ...
    var classes = (cn$5('') + " " + className).trim();
    return (React__default.createElement("div", { className: classes },
        React__default.createElement("div", { className: cn$5('image') }, image && React__default.createElement("img", { src: image, alt: "img" })),
        title && React__default.createElement("p", { className: cn$5('title') }, title),
...
var cn$6 = withNaming({ e: '__', m: '-' })('Checkbox');
...
function getNotificationInstance(_a, callback) {
    ...
    Notification.newInstance({
        ...
        closeIcon: createElement(Icon, { className: "Notification-close-icon", icon: "close" }),
...
function notice(args) {
    ...
    var iconNode = null;
    if (args.icon) {
        iconNode = createElement("span", { className: prefixCls + "-icon" }, args.icon);
    }
    else if (args.type) {
        var iconType = typeToIcon[args.type];
        iconNode = createElement(Icon, { className: prefixCls + "-icon", icon: iconType.icon, color: iconType.color });
    }
    var autoMarginTag = !args.description && iconNode ? (createElement("span", { className: prefixCls + "-message-single-line-auto-margin" })) : null;
    ...
    getNotificationInstance({
        ...
        notification.notice({
            content: (createElement("div", { className: iconNode ? prefixCls + "-with-icon" : '' },
                iconNode,
                createElement("div", { className: prefixCls + "-message" },
                    autoMarginTag,
                    args.message),
                createElement("div", { className: prefixCls + "-description" }, args.description),
                args.btn ? createElement("span", { className: prefixCls + "-btn" }, args.btn) : null)),
            duration: duration,
            closable: true,
...
var cn$7 = withNaming({ e: '__', m: '-' })('Switch');
var Switch = React__default.forwardRef(function (props, ref) {
    ...
    return (React__default.createElement("div", { className: classes },
        ...
        (children || label) && (React__default.createElement("span", { className: "label" },
            children || label,
            " ",
            required && React__default.createElement("span", { className: cn$7('required') }, "*")))));
});
    ...
    function CollapsePanel() {
        ...
        _this.renderCollapsePanel = function () {
            ...
            var collapsePanelClassName = classNames((_a = {},
                ...
                _a), className);
            return createElement(RcCollapse.Panel, __assign({}, _this.props, { className: collapsePanelClassName }));
        };
        return _this;
    }
    CollapsePanel.prototype.render = function () {
        return createElement(Fragment, null, this.renderCollapsePanel());
    };
...
(0, reactLifecyclesCompat.polyfill)(MonthTable);
...
(0, reactLifecyclesCompat.polyfill)(MonthPanel);
...
exports['default'] = (0, reactLifecyclesCompat.polyfill)((0, CalendarMixin.calendarMixinWrapper)((0, CommonMixin.commonMixinWrapper)(MonthCalendar)));
module.exports = exports['default'];
});
...
(0, reactLifecyclesCompat.polyfill)(Picker);
    ...
    var CalenderWrapper = (function (_super) {
        ...
        function CalenderWrapper(props) {
            ...
            _this.renderFooter = function () {
                ...
                return renderExtraFooter ? (createElement("div", { className: prefixCls + "-footer-extra" }, renderExtraFooter.apply(void 0, args))) : null;
            };
            _this.renderPicker = function () {
                ...
                var calendar = (createElement(TheCalendar, __assign({}, calendarProps, { disabledDate: props.disabledDate, disabledTime: disabledTime, timePicker: props.timePicker, defaultValue: props.defaultPickerValue || interopDefault(moment)(), dateInputPlaceholder: placeholder, prefixCls: prefixCls, className: calendarClassName, onOk: props.onOk, dateRender: props.dateRender, format: props.format, showToday: props.showToday, monthCellContentRender: props.monthCellContentRender, renderFooter: _this.renderFooter, onPanelChange: props.onPanelChange, onChange: _this.handleCalendarChange, value: showDate })));
                var clearIcon = !props.disabled && props.allowClear && value ? (createElement(Icon, { icon: "close", className: prefixCls + "-picker-clear", onClick: _this.clearSelection })) : null;
                var inputIcon = (createElement(Icon, { icon: "calendar_today", className: prefixCls + "-picker-icon " + prefixCls + "-picker-icon-calendar" }));
                var dataOrAriaProps = getDataOrAriaProps(props);
                var input = function (_a) {
                    var inputValue = _a.value;
                    return (createElement("div", null,
                        createElement("input", __assign({ ref: _this.saveInput, disabled: props.disabled, readOnly: true, value: formatDate(inputValue, props.format), placeholder: placeholder, className: props.pickerInputClass, tabIndex: props.tabIndex, name: props.name }, dataOrAriaProps)),
                        clearIcon,
                        inputIcon));
                };
                return (createElement("span", { id: props.id, className: classNames(props.className, props.pickerClass), style: __assign(__assign({}, pickerStyle), props.style), onFocus: props.onFocus, onBlur: props.onBlur, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave },
                    createElement(RcDatePicker, __assign({}, props, pickerProps, { calendar: calendar, value: value, prefixCls: prefixCls + "-picker-container", style: props.popupStyle, open: open, onOpenChange: _this.handleOpenChange }), input)));
            };
            var value = props.value || props.defaultValue;
...
(0, reactLifecyclesCompat.polyfill)(Panel);
var _default = Panel;
exports["default"] = _default;
});
...
var TimePicker$1 = (function (_super) {
    ...
    TimePicker.prototype.renderInputIcon = function (prefixCls) {
        var clockIcon = createElement(Icon, { icon: "access_time", className: prefixCls + "-clock-icon" });
        return createElement("span", { className: prefixCls + "-icon" }, clockIcon);
    };
    TimePicker.prototype.renderClearIcon = function (prefixCls) {
        var clearIconPrefixCls = prefixCls + "-clear";
        return createElement(Icon, { icon: "access_time", className: clearIconPrefixCls });
    };
    ...
    var PickerWrapper = (function (_super) {
        ...
        function PickerWrapper() {
            ...
            _this.renderPicker = function () {
                ...
                var timePicker = showTime ? (createElement(TimePickerPanel, __assign({}, rcTimePickerProps, showTime, { prefixCls: "DatePicker-time-picker", className: timePickerCls, placeholder: "Select Time", transitionName: "slide-up" }))) : null;
                return (createElement(Picker, __assign({}, _this.props, { getCalendarContainer: getPopupContainer, format: mergedFormat, ref: _this.savePicker, pickerClass: pickerClass, pickerInputClass: pickerInputClass, timePicker: timePicker, onOpenChange: _this.handleOpenChange, onFocus: _this.handleFocus, onBlur: _this.handleBlur, onMouseEnter: _this.handleMouseEnter, onMouseLeave: _this.handleMouseLeave })));
            };
            return _this;
        }
...
(0, reactLifecyclesCompat.polyfill)(DateInput);
...
(0, reactLifecyclesCompat.polyfill)(RangeCalendar);
...
var CheckableTag = (function (_super) {
    ...
    function CheckableTag() {
        ...
        _this.renderCheckableTag = function () {
            ...
            return createElement("span", __assign({}, restProps, { className: cls, onClick: _this.handleClick }));
        };
        return _this;
    }
...
var Tag = (function (_super) {
    ...
    function Tag(props) {
        ...
        _this.renderTag = function () {
            ...
            return (createElement("span", __assign({}, tagProps, { className: _this.getTagClassName(), style: _this.getTagStyle() }),
                children,
    ...
    Tag.prototype.renderCloseIcon = function () {
        ...
        return closable ? (createElement(Icon, { icon: "close", className: "Tag-close", onClick: this.handleIconClick })) : null;
    };
...
var RangePicker = (function (_super) {
    ...
    function RangePicker(props) {
        ...
        _this.renderFooter = function () {
            ...
            var customFooter = renderExtraFooter ? (createElement("div", { className: prefixCls + "-footer-extra", key: "extra" }, renderExtraFooter())) : null;
            var operations = Object.keys(ranges || {}).map(function (range) {
                var value = ranges[range];
                return (createElement(Tag, { key: range, prefixCls: tagPrefixCls, color: "blue", onClick: function () { return _this.handleRangeClick(value); }, onMouseEnter: function () { return _this.setState({ hoverValue: value }); }, onMouseLeave: _this.handleRangeMouseLeave }, range));
            });
            var rangeNode = operations && operations.length > 0 ? (createElement("div", { className: prefixCls + "-footer-extra " + prefixCls + "-range-quick-selector", key: "range" }, operations)) : null;
        ...
        _this.renderRangePicker = function () {
            ...
            var calendar = (createElement(RangeCalendar, __assign({}, calendarProps, { seperator: separator, onChange: onCalendarChange, format: format, prefixCls: prefixCls, className: calendarClassName, renderFooter: _this.renderFooter, timePicker: props.timePicker, disabledDate: disabledDate, disabledTime: disabledTime, dateInputPlaceholder: [startPlaceholder, endPlaceholder], locale: locale.lang, onOk: onOk, dateRender: dateRender, value: showDate, onValueChange: _this.handleShowDateChange, hoverValue: hoverValue, onHoverChange: _this.handleHoverChange, onPanelChange: props.onPanelChange, showToday: showToday, onInputSelect: _this.handleCalendarInputSelect })));
            var pickerStyle = {};
            if (props.showTime) {
                pickerStyle.width = (style && style.width) || 350;
            }
            var _c = value, startValue = _c[0], endValue = _c[1];
            var clearIcon = !props.disabled && props.allowClear && value && (startValue || endValue) ? (createElement(Icon, { icon: "access_time", className: prefixCls + "-picker-clear", onClick: _this.clearSelection })) : null;
            var inputIcon = (createElement(Icon, { icon: "calendar_today", className: prefixCls + "-picker-icon " + prefixCls + "-picker-icon-calendar" }));
            var input = function (_a) {
                var inputValue = _a.value;
                var start = inputValue[0], end = inputValue[1];
                return (createElement("span", { className: props.pickerInputClass },
                    createElement("input", { disabled: props.disabled, readOnly: true, value: formatDate(start, props.format), placeholder: startPlaceholder, className: prefixCls + "-range-picker-input", tabIndex: -1 }),
                    createElement("span", { className: prefixCls + "-range-picker-separator" },
                        " ",
                        separator,
                        " "),
                    createElement("input", { disabled: props.disabled, readOnly: true, value: formatDate(end, props.format), placeholder: endPlaceholder, className: prefixCls + "-range-picker-input", tabIndex: -1 }),
                    clearIcon,
                    inputIcon));
            };
            return (createElement("span", { ref: _this.savePicker, id: props.id, className: classNames(props.className, props.pickerClass), style: __assign(__assign({}, style), pickerStyle), tabIndex: props.disabled ? -1 : 0, onFocus: props.onFocus, onBlur: props.onBlur, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave },
                createElement(RcDatePicker, __assign({}, props, pickerChangeHandler, { calendar: calendar, value: value, open: open, onOpenChange: _this.handleOpenChange, prefixCls: prefixCls + "-picker-container", style: popupStyle }), input)));
        };
        var value = props.value || props.defaultValue || [];
        var start = value[0], end = value[1];
    ...
    function WeekPicker(props) {
        ...
        _this.weekDateRender = function (current) {
            ...
            if (selectedValue &&
                ...
                return (createElement("div", { className: prefixCls + "-selected-day" },
                    createElement("div", { className: prefixCls + "-date" }, dateNode)));
            }
            return createElement("div", { className: prefixCls + "-date" }, dateNode);
        };
        _this.handleChange = function (value) {
            if (!('value' in _this.props)) {
                _this.setState({ value: value });
        ...
        _this.renderWeekPicker = function () {
            ...
            var calendar = (createElement(Calendar, { showWeekNumber: true, dateRender: _this.weekDateRender, prefixCls: prefixCls, format: format, locale: locale.lang, showDateInput: false, showToday: false, disabledDate: disabledDate, renderFooter: _this.renderFooter }));
            var clearIcon = !disabled && allowClear && _this.state.value ? (createElement(Icon, { icon: "close", className: prefixCls + "-picker-clear", onClick: _this.clearSelection })) : null;
            var inputIcon = (createElement(Icon, { icon: "calendar_today", className: prefixCls + "-picker-icon " + prefixCls + "-picker-icon-calendar" }));
            var input = function (_a) {
                var value = _a.value;
                return (createElement("span", { style: { display: 'inline-block', width: '100%' } },
                    createElement("input", { ref: _this.saveInput, disabled: disabled, readOnly: true, value: (value && value.format(format)) || '', placeholder: placeholder, className: pickerInputClass, onFocus: onFocus, onBlur: onBlur }),
                    clearIcon,
                    inputIcon));
            };
            return (createElement("span", { className: classNames(className, pickerClass), style: style, id: id },
                createElement(RcDatePicker, __assign({}, _this.props, { calendar: calendar, prefixCls: prefixCls + "-picker-container", value: pickerValue, onChange: _this.handleChange, open: open, onOpenChange: _this.handleOpenChange, style: popupStyle }), input)));
        };
        var value = props.value || props.defaultValue;
        if (value && !interopDefault(moment).isMoment(value)) {
...
var cn$8 = withNaming({ e: '__', m: '--' })('Richtext');
var Richtext = (function (_super) {
    ...
    Richtext.prototype.render = function () {
        ...
        var id = Math.random()
            .toString(36)
            .substr(2, 9);
        return (React__default.createElement("div", { className: classNames(className, cn$8('', { error: (error && touched) || (submitted && error) })) },
            label && (React__default.createElement("label", { className: cn$8('label') },
                label,
                " ",
                this.props.required && React__default.createElement("span", { className: cn$8('required') }, "*"))),
            ...
            (error && touched) || (submitted && error) ? (React__default.createElement("p", { className: cn$8('error-message') }, error)) : ('')));
    };
    return Richtext;
}(Component));
...
var url = (process.env.REACT_APP_API_URL || 'http://localhost/api/v1') + "/file-upload";
var cn$9 = withNaming({ e: '__', m: '--' })('FileUploader');
var FileUploader = function (props) {
    var _a = useState(''), id = _a[0], setId = _a[1];
    var fileWrapper = useRef(null);
    ...
    return (React__default.createElement("div", { className: cn$9('', { error: props.error ? true : false }), ref: fileWrapper },
        React__default.createElement("div", { className: cn$9('form') },
            React__default.createElement("label", { className: cn$9('button'), htmlFor: id }, "Select Files"),
            React__default.createElement("input", { hidden: true, id: id, onChange: onChange, type: "file", multiple: props.multiple })),
        React__default.createElement("progress", { className: cn$9('progress'), ref: progressBar, max: 100, value: 0 }),
        props.value && props.value.length ? (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("div", { className: cn$9('uploaded') }, props.value.map(function (u, i) {
                return u.mediaType.includes('image') && (React__default.createElement("div", { key: i, className: cn$9('uploaded__wrapper') },
        ...
        props.error ? React__default.createElement("p", { className: cn$9('error') }, props.error) : null));
};
...
var cn$a = withNaming({ e: '__', m: '-' })('Radio');
var Radio = React__default.forwardRef(function (props, ref) {
    ...
    return (React__default.createElement("label", { className: classes },
        ...
        React__default.createElement("span", { className: "label" },
            ...
            " ",
            required && React__default.createElement("span", { className: cn$a('required') }, "*"))));
});

function useForm(validate) {
    var _a = useState({}), values = _a[0], setValues = _a[1];
    var _b = useState({}), errors = _b[0], setErrors = _b[1];
    var _c = useState(false), valid = _c[0], setValid = _c[1];
    useEffect(function () {
...
export { Button, Checkbox, Collapse, Currency, DatePicker, FileUploader, Icon, Input, LanguageSwitch, Modal, api as Notification, OverlayComponent, PhoneNumber, Radio, RichTextDisplay, Richtext, SVG, Switch, Table, Tag, TimePicker$1 as TimePicker, TranslateConnect, TranslateProvider, TypeAhead, changeUrlLanguage, checkPhoneNumberValidity, createPath, disableScroll, enableScroll, extractFromUrl, getDataOrAriaProps, getPassedPhoneNumber, newId, numWithCommas, useForm, validate };
