(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bem-react/classname'), require('react-phone-number-input'), require('rc-dialog'), require('react-dom'), require('classnames'), require('react-select'), require('rc-notification'), require('rc-collapse'), require('rc-calendar'), require('react-lifecycles-compat'), require('moment'), require('omit.js'), require('shallowequal')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@bem-react/classname', 'react-phone-number-input', 'rc-dialog', 'react-dom', 'classnames', 'react-select', 'rc-notification', 'rc-collapse', 'rc-calendar', 'react-lifecycles-compat', 'moment', 'omit.js', 'shallowequal'], factory) :
    (global = global || self, factory(global.Component = {}, global.React, global.classname, global.PhoneInput, global.Dialog, global.ReactDOM, global.classNames, global.Select, global.Notification, global.RcCollapse, global.Calendar, global.reactLifecyclesCompat, global.moment, global.omit, global.shallowequal));
}(this, (function (exports, React, classname, PhoneInput, Dialog, ReactDOM, classNames, Select, Notification, RcCollapse, Calendar, reactLifecyclesCompat, moment, omit, shallowequal) { 'use strict';
